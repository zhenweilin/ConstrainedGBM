...
bool CheckMultiClassObjective(const std::string& objective) {
  return (objective == std::string("multiclass") || objective == std::string("multiclassova") || objective == std::string("multiclass_my") || objective == std::string("multiclass_np") || objective == std::string("multiclass_fair"));
}
...
void Config::CheckParamConflict() {
  ...
  for (std::string metric_type : metric) {
    bool metric_type_multiclass = (CheckMultiClassObjective(metric_type)
                                   ...
                                   || metric_type == std::string("multi__np")
                                   || metric_type == std::string("multi_fair")
