...
struct LinearSquareLoss {
  ...
  XGBOOST_DEVICE static bst_float FirstOrderGradient(bst_float predt, bst_float label, bst_float w) {
    return predt - label;
  }
  XGBOOST_DEVICE static bst_float SecondOrderGradient(bst_float, bst_float, bst_float w) { return 1.0f; }
...
struct SquaredLogError {
  ...
  XGBOOST_DEVICE static bst_float SecondOrderGradient(bst_float predt, bst_float label, bst_float w) {
...
struct LogisticRegression {
  ...
  XGBOOST_DEVICE static bst_float SecondOrderGradient(bst_float predt, bst_float, bst_float w) {
