 ...
 * \file objective.cc
 * \brief Registry of all objective functions (add neyman pearson and fariness objective function).
 * \author Modified by Authorname
 */
...
DMLC_REGISTRY_LINK_TAG(multiclass_obj_fair);
DMLC_REGISTRY_LINK_TAG(multiclass_obj_np);
