...
void PredictBatchByBlockOfRowsKernel(
  ...
  // LOG(CONSOLE) <<"num_ngroup237:" << model.learner_model_param->num_output_group <<"\n";
...
class CPUPredictor : public Predictor {
 protected:
  ...
  void PredictDMatrix(DMatrix *p_fmat, std::vector<bst_float> *out_preds,
    ...
    for (auto const &batch : p_fmat->GetBatches<SparsePage>()) {
      // LOG(CONSOLE) <<"batch342:" << model.learner_model_param->num_output_group <<"\n";
 ...
 public:
  ...
  void PredictInstance(const SparsePage::Inst& inst,
    ...
    // LOG(CONSOLE) <<"ntree_limit429:" << model.learner_model_param->num_output_group <<"\n";
  ...
  void PredictContribution(DMatrix *p_fmat,
    ...
    // LOG(CONSOLE) <<"ngroup497:" << model.learner_model_param->num_output_group <<"\n";
    CHECK_NE(ngroup, 0);
    ...
    // LOG(CONSOLE) <<"groups504:" << model.learner_model_param->num_output_group <<"\n";
